...
if y2 < y1 and y4 < y3:
    ...
    if x2 == x3 and y1 == y4:
        print("прямоугольники пересекаются в точке (" + str(x2) + ";" + str(y1) + ")")
    if x3 > x1 and x3 < x2 and y4 > y2 and y4 < y1:
...
if y2 > y1 and y4 < y3:
    if x1 == x3 and y1 == y4 and  x2 == x4 and y2 == y3:
        print("прямоугольники совподают!")
    if x1 == x4 and y2 == y4:
        print("прямоугольники пересекаются в точке (" + str(x1) + ";" + str(y2) + ")")
    if x2 == x3 and y1 == y3:
    ...
    if x2 == x3 and y2 == y4:
        print("прямоугольники пересекаются в точке (" + str(x2) + ";" + str(y2) + ")")
    if x3 > x1 and x3 < x2 and y4 > y1 and y4 < y2:
        print("Прямоугольники пересекаются в 2 точках: ( " + str(x3) + " ; " + str(y2) + " ) , ( " + str(x2) + " , " + str(y4) + " )")
    if x1 > x3 and x1 < x4 and y1 > y4 and y1 < y3:
        print("Прямоугольники пересекаются в 2 точках: ( " + str(x1) + " ; " + str(y3) + " ) , ( " + str(x4) + " , " + str(y1) + " )")
if y2 < y1 and y4 > y3:
    if x1 == x3 and y1 == y4 and  x2 == x4 and y2 == y3:
        print("прямоугольники совподают!")
    if x1 == x4 and y1 == y3:
    ...
    if x3 > x1 and x3 < x2 and y3 > y2 and y3 < y1:
        print("Прямоугольники пересекаются в 2 точках: ( " + str(x3) + " ; " + str(y1) + " ) , ( " + str(x2) + " , " + str(y3) + " )")
    if x1 > x3 and x1 < x4 and y2 > y3 and y2 < y4:
        print("Прямоугольники пересекаются в 2 точках: ( " + str(x1) + " ; " + str(y4) + " ) , ( " + str(x4) + " , " + str(y2) + " )")
